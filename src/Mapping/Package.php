...
use DavidVerholen\Magento\Composer\Installer\Mapping\Exception\InvalidTargetException;
use DavidVerholen\Magento\Composer\Installer\Mapping\Exception\UnknownPathtypeException;
