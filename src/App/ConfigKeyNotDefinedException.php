<?php
/**
 * ConfigKeyNotDefinedException.php
 *
 * PHP Version 5
 *
...
/**
 * Class ConfigKeyNotDefinedException
 *
 * @category magento-composer-installer
...
class ConfigKeyNotDefinedException extends \Exception
{
     ...
     *
     * @param string    $key      [optional] The Exception message to throw.
    ...
    public function __construct(
        ...
        parent::__construct(
            sprintf('Config Key not defined: %s', $key),
            $code,
            $previous
        );
    }
